...
const Home: NextPage = () => {
	...
	return (
		<div className="flex flex-col space-y-5 py-16">
				...
				>
					<div className="flex space-x-4">
						...
						<div className="pt-2 flex flex-col">
							<h3 className="text-sm text-gray-900 font-semibold">New iPhone 14</h3>
			...
			<button
				className="fixed shadow-xl bottom-20 right-5 bg-orange-400 rounded-full p-4 text-white hover:bg-orange-500 cursor-pointer"
