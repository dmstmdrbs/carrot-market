		...
		<Layout title="나의 캐럿" hasTabBar>
			<div className="py-10 px-4">
				<div className="flex items-center space-x-3">
					...
					<div className="flex flex-col">
						...
						<span
							...
							className="text-sm text-gray-700 hover:text-orange-500 transition-colors cursor-pointer"
						>
							Edit profile &rarr;
						</span>
					</div>
				...
				<div className="mt-10 flex justify-around">
					<div className="cursor-pointer flex flex-col items-center" onClick={() => router.push("/profile/sold")}>
					...
					<div className="cursor-pointer flex flex-col items-center" onClick={() => router.push("/profile/bought")}>
						<div className="w-14 h-14 text-white bg-orange-400 rounded-full flex items-center justify-center">
							<svg
								className="w-6 h-6"
								fill="none"
					...
					<div className="cursor-pointer flex flex-col items-center" onClick={() => router.push("/profile/loved")}>
						<div className="w-14 h-14 text-white bg-orange-400 rounded-full flex items-center justify-center">
							<svg
								className="w-6 h-6"
								fill="none"
